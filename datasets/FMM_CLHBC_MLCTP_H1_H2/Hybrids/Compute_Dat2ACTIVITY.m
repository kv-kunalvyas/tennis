function TM = Compute_Dat2ACTIVITY(Seq,Topology,Tree)
%  part1{1}=part{88};
% clear part
%  part=part1;


if isequal(Topology.Level_elements,[1 11])
    Div=Tree{2};
    [BASE] = Build_master_topology_MSN_11events(Seq);
...
[TMat{length(Topology.Level_elements)} ] = Build_master_topology_MSN_11events(Seq);
k=1;
