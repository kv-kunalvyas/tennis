clear
    ...
    Test_Seq = cellstr(num2str(Data(8001:10000)));

[cza Test_T]=MSN_test_CLHBC(Test_Seq);
ST=length(Train_Seq);
n=0;
TT=1;
k=0;
...
MMLDP_CLHBC_Confmatrix=mat2tmat(summ./100);
MMLDP_CLHBC_EventsPrediction=sumnCC./100;
MMLDP_CLHBC_mean=mean(me(Topology_number,:));
MMLDP_CLHBC_std=std(me(Topology_number,:));

% save MMLDP_CLHBC.mat MMLDP_CLHBC_Confmatrix MMLDP_CLHBC_EventsPrediction MMLDP_CLHBC_mean MMLDP_CLHBC_std
