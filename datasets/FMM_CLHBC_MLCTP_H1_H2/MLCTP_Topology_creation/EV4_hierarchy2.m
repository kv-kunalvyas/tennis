...
for i=1:Sizzz(1)
    for j=1:Sizzz(2)
        ...
        PS(i,j) = {'H'};
        elseif strcmp(Seq{i,j},'BIF') || strcmp(Seq{i,j},'BIN') || strcmp(Seq{i,j},'BOF') || strcmp(Seq{i,j},'BON') || strcmp(Seq{i,j},'BIFSL')...
                || strcmp(Seq{i,j},'BINSL') ||  strcmp(Seq{i,j},'BIFSR') || strcmp(Seq{i,j},'BINSR')|| strcmp(Seq{i,j},'BOFS') || strcmp(Seq{i,j},'BONS')
        PS(i,j) = {'B'};
        end
    end
end
