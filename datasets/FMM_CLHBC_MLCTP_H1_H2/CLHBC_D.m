function [hMM hST hCC Conf] = CLHBC_D(Driving_Events,Train_Seqs,Test_Seqs,n,st)
...
for i=1:length(Driving_Events)-n-iter+1
    ...
    %[LH_Train{i} Train_Seq{i} TrMatrix{i}] = EV4_hierarchy2(Train_Seqst);
    %[LH_Test Test_Seq TeMatrix] = EV4_hierarchy2(Test_Seqs);
    
    [LH_Train{i} Train_Seq{i} TrMatrix{i}] = EV4_hierarchy3levels(Train_Seqst);
